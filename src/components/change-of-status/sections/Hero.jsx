    ...
    >
      <div className="max-w-5xl mx-auto text-center">
        ...
        <motion.p
          ...
          className="inline-block bg-[#0c1424] text-gray-200 text-xs sm:text-sm px-3 sm:px-4 py-1 rounded-full border border-gray-600"
        >
        ...
        <motion.h1
          ...
          className="text-2xl sm:text-3xl md:text-5xl font-bold mt-4 leading-tight"
        >
        ...
        <motion.p
          ...
          className="text-gray-300 mt-2 text-sm sm:text-base md:text-lg max-w-3xl mx-auto"
        >
        ...
        <motion.div
          ...
          className="bg-white text-gray-800 mt-8 sm:mt-10 p-5 sm:p-6 md:p-10 rounded-2xl shadow-lg"
        >
          ...
          <motion.div
            ...
            className="bg-[#FFE5D0] border border-[#FF6B00] rounded-xl p-4 mt-5 sm:mt-6 text-left"
          >
        ...
        >
          ...
          <button className="w-full sm:w-auto border border-[#FF6B00] text-[#FF6B00] hover:bg-[#FF6B00] hover:text-white font-medium px-6 py-3 rounded-md shadow-md transition active:scale-95">
        ...
        <motion.div
          ...
          className="bg-[#3C1F17] border border-[#FF6B00] rounded-lg text-xs sm:text-sm text-gray-200 px-4 sm:px-6 py-3 sm:py-4 mt-8 sm:mt-10 max-w-3xl mx-auto"
        >
