...
const Hero = () => {
  return (
    <section
      className="relative w-full min-h-[100vh] pt-[200px] flex flex-col items-center text-white 
  bg-[#031225] overflow-hidden pb-[3rem]
  bg-[url('/Home-Hero-bg.png')] bg-cover bg-no-repeat bg-[center_140px]"
    >
