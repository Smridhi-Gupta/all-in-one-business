    ...
    <section className="relative w-full bg-white overflow-hidden py-14">
      ...
      <div className="flex flex-col items-center mb-24">
        ...
        <div className="relative w-full flex justify-center">
          {/* BLACK CONTAINER (SIZE SAME) */}
          <div className="bg-[#0B1221] w-[90%] max-w-5xl rounded-2xl shadow-lg relative z-10 overflow-hidden">
            {/* EDGE TO EDGE SWIPER */}
            <Swiper
              modules={[Autoplay]}
              autoplay={{
            ...
            >
              {partners.map((logo, i) => (
                <SwiperSlide
                  key={i}
                  className="!w-[180px] flex justify-center items-center py-4"
                >
                  <Image
                    src={logo}
                    alt="partner logo"
      ...
      {/* ===== INFINITY BG ===== */}
      <div className="absolute inset-0 flex justify-center items-center translate-y-24">
        <Image
          src="/infinity.png"
          alt="background"
          width={1300}
        ...
        {services.map((service, index) => {
          ...
          return (
            <motion.div
              ...
              className={`
          group relative h-[420px] rounded-2xl
        ...
        `}
            >
              <div>
                ...
                {/* DESC */}
                <p className="mb-6 text-gray-600 group-hover:text-gray-300 transition">
                  {service.desc}
                </p>
