        ...
        {services.map((service, index) => {
          ...
          return (
            <motion.div
              ...
              className={`relative w-full h-[420px] rounded-2xl shadow-[0_8px_25px_rgba(0,0,0,0.15)]
        p-6 flex flex-col justify-between transition-all ${marginClass}
        ${
          service.dark ? "bg-[#031225] text-white" : "bg-white text-[#031225]"
        }`}
            >
              <div>
              ...
              {/* SERVICE CARD IMAGE - FIXED LIKE FIRST SCREENSHOT */}
