...
export default function Hero() {
  return (
    <section
      className="w-full min-h-screen text-white flex items-center justify-center px-4 sm:px-6 py-22 sm:py-20 bg-cover bg-center relative"
      style={{
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
        {/* LEFT TEXT CONTENT */}
        <div className="space-y-5 text-center lg:text-left">
          <span className="inline-block text-xs sm:text-sm font-medium tracking-wide uppercase px-3 py-1 rounded-full border border-white/50 text-[#FF5100]">
        ...
        <div className="bg-white/5 backdrop-blur-lg rounded-2xl border border-white/10 px-6 sm:px-10 py-7 sm:py-9 shadow-[0_0_40px_rgba(0,0,0,0.25)] max-w-md w-full mx-auto">
  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-2">
        {/* ICON BOX */}
        <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-white/15 flex items-center justify-center text-[#FF5100] text-lg sm:text-xl">
          {icon}
        </div>

        <p className="text-sm sm:text-md text-gray-200">{label}</p>
      </div>
