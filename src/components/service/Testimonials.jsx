        ...
        <div className="relative">
          ...
          <div
            className="
              ...
              border border-gray-100 text-left relative
            "
          >
            {/* Quote Icon */}
            ...
            <div className="mt-6 flex items-center gap-4">
              ...
              {/* Avatar Placeholder */}
              <div className="w-12 h-12 rounded-full bg-gray-300 flex items-center justify-center text-sm font-bold text-[#031225]">
            ...
            <div className="absolute bottom-6 right-6 flex gap-3">
              <button
                ...
                className="
                  ...
                  bg-gray-100 hover:bg-[#FF5100]
                  hover:text-white text-[#031225] transition
                "
              >
                <ChevronLeft size={16} />
              </button>
