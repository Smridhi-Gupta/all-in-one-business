...
export default function WhatIsDigitalMarketing() {
  return (
    <section className="w-full pt-40 pb-20 px-6 bg-[#e6f2ff] -mt-27">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        {/* LEFT CONTENT */}
        <div className="space-y-6">
          <h2 className="text-3xl md:text-5xl font-extrabold text-[#031225] leading-snug">
          ...
          <div className="grid grid-cols-2 gap-y-3 pt-2">
            {[
              ...
              <div key={i} className="flex items-center gap-2">
                <CheckCircle size={20} className="text-[#FF5100]" />
        ...
        >
          {features.map((f, i) => (
            ...
            >
              ...
              <h3 className="mt-2 font-bold text-[#031225] text-lg">
                {f.title}
              </h3>
              <p className="text-md text-gray-500">{f.subtitle}</p>
            </div>
          ))}
        </div>
      </div>
